...
%prod.quarkus.rest-client.onecx_user_profile_svc_v1_yaml.url=http://onecx-user-profile-svc:8080
...
quarkus.openapi-generator.codegen.spec.onecx_user_profile_svc_v1_yaml.config-key=onecx_user_profile_svc_v1_yaml
quarkus.openapi-generator.codegen.spec.onecx_user_profile_svc_v1_yaml.base-package=org.openapi.quarkus.onecx_user_profile_svc_v1_yaml
...
%prod.quarkus.rest-client.onecx_user_profile_svc_v1_yaml.providers=io.quarkus.oidc.client.reactive.filter.OidcClientRequestReactiveFilter
